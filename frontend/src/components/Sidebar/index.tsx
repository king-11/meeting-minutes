    ...
    return (
      <div className="flex flex-col items-center space-y-4 mt-4">
        ...
        <button
          ...
          className={`p-2 ${isRecording ? "bg-glean-500 cursor-not-allowed" : "bg-glean-500 hover:bg-glean-600"} rounded-full transition-colors shadow-sm`}
            ...
            <div className="flex flex-col w-full">
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center">
                  {isMeetingItem ? (
                    <div
                      className={`flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full mr-2 ${
                        isDisabled
                          ? "bg-gray-100"
                          : hasTranscriptMatch
                            ? "bg-yellow-100"
                  ...
                  <span
                    className={`break-words pr-6 ${isDisabled ? "text-gray-400" : ""}`}
                  >
                    {item.title}
                  </span>
                </div>
                {isMeetingItem && !isDisabled && (
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 hover:text-glean-600 p-1 rounded-md hover:bg-glean-50 transition-opacity duration-200 flex-shrink-0 ml-1"
              ...
              <div className="p-3">
                ...
                <div className="relative mb-1">
                  ...
                  <input
                    ...
                    className="block w-full pl-8 pr-3 py-1.5 border border-gray-200 rounded-md text-xs placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-glean-500 focus:border-glean-500"
                  />
                  {searchQuery && (
                    <button
                    ...
                    <div key={item.id}>
                      ...
                      >
                        ...
                        {searchQuery &&
                          item.id === "meetings" &&
                          isSearching && (
                            <span className="ml-2 text-xs text-glean-500 animate-pulse">
                              Searching...
                            </span>
                          )}
                      </div>
        ...
        {!isCollapsed && (
          <div className="flex-shrink-0 p-2 border-t border-gray-100">
            <button
              onClick={handleRecordingToggle}
              disabled={isRecording}
              className={`w-full flex items-center justify-center px-3 py-2 text-sm font-medium text-white ${isRecording ? "bg-glean-300 cursor-not-allowed" : "bg-glean-500 hover:bg-glean-600"} rounded-lg transition-colors shadow-sm`}
            >
              {isRecording ? (
                <>
