...
export function About() {
  const handleContactClick = async () => {
    try {
      await invoke("open_external_url", { url: "https://glean.com/" });
    } catch (error) {
    ...
    <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
      ...
      <div className="space-y-3">
        <h2 className="text-base font-semibold text-gray-800">
          What makes Glean Meeting Minutes different
        </h2>
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="bg-blue-50 rounded p-3 hover:bg-blue-100 transition-colors border border-blue-100">
            ...
            <p className="text-xs text-blue-700 leading-relaxed">
              Powered by Glean's enterprise search capabilities for instant
              meeting insights and knowledge discovery.
            </p>
          </div>
          <div className="bg-blue-50 rounded p-3 hover:bg-blue-100 transition-colors border border-blue-100">
      ...
      <div className="bg-blue-50 rounded p-3">
        <p className="text-s text-blue-800">
          <span className="font-bold">Powered by Glean:</span> Advanced AI
          capabilities for intelligent meeting analysis, action tracking, and
      ...
      <div className="text-center space-y-2">
        <h3 className="text-medium font-semibold text-gray-800">
          Unlock the power of enterprise search
        </h3>
        <p className="text-s text-gray-600">
          Experience how Glean transforms your organization's knowledge into{" "}
          <span className="font-bold">instant insights</span> and intelligent
          meeting summaries.
        </p>
        <button
      ...
      <div className="pt-2 border-t border-gray-200 text-center">
        <p className="text-xs text-gray-400">Powered by Glean</p>
      </div>
    </div>
  );
}
